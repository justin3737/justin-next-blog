...
- 這裡用到 ant design 的元件 Modal.confirm

- 寫法與 js 的 confirm（） 很相似

- onOk() 裡面 dispatch action: delList(id) 就完成了
...
_Originally published at [github.com](https://github.com/justin3737/redux-message-board/issues/6)._
